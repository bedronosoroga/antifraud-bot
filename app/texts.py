...
def menu_help_text() -> str:
    return (
        ...
        "📊 <b>Что вы получите</b>\n"
        "<b>Индекс перевозчика</b> — показывает, со сколькими надёжными заказчиками компания имела подтверждённые сделки за год.\n"
        ...
        "🟢 <b>Низкий риск</b> — компания выглядит надёжно.\n"
        "🟡 <b>Средний риск</b> — проверьте детали перед сделкой.\n"
        "🔴 <b>Высокий риск</b> — будьте осторожны: возможны проблемы.\n\n"
